        ...
        <div className={styles.container}>
            <div className={styles.cartHeader}>
                ...
                <p className={styles.orderNumber}>
                    Заказ {cartState.uid.toUpperCase()}
                </p>
            </div>
            {cartTotalPrice == 0 && (
                <h3 className={styles.emptyCart}>Корзина пуста</h3>
            )}
            {cartTotalPrice != 0 && (
                <div className={styles.orderInfoContainer}>
                    <h3 className={styles.itemsAmmount}>
                        Товаров в заказе:{" "}
                        <span className={styles.boldtxt}>
                            {cartState.items.length} шт
                        </span>
                    </h3>
                    <h3 className={styles.itemsAmmount}>
                        Общая сумма заказа:{" "}
                        <span className={styles.boldtxt}>
                            {mapPrice(cartTotalPrice)} ₽
                        </span>
                    </h3>
                    <input
                        type="checkbox"
                    ...
                    <form
                        className={styles.cartInputForm}
