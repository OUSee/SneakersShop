        ...
        <div className={styles.container}>
            <div id='contacts' className='content'>
                <div className={styles.contentContainer}>
                    ...
                    <p className={styles.adress}>г. Санкт-Петербург, Комсомольская, 43 к1</p>
                    <p className={styles.infoTitle}>отдел продаж</p>
                    <h2 className={styles.number}>+7 800 789 89 89</h2>
                    <p className={styles.adress}>г. Санкт-Петербург, Комсомольская, 43 к1</p>
                    <div className={styles.linksIcons}>
                        <a className={styles.vkLink} href="https://vk.com/luckyoneboy">
                            <img className={styles.svg} src="../src/assets/vkIcon.svg"/>
                        </a>
                        <a className={styles.instagramLink} href="https://www.instagram.com/dicedites_vir">
                            <img className={styles.svg} src="../src/assets/instagramIcon.svg"/>
                        </a>
                    </div>
                </div>
                <div className={styles.mapcontainer}>
                    <div className={styles.map}>
                        <div
                            className={styles.mapFirstDiv}
                        >
                            <a href="https://yandex.ru/maps/121642/innopolis/?utm_medium=mapframe&utm_source=maps" className={styles.mapASity}>
                                Иннополис
                            </a>
                            <a
