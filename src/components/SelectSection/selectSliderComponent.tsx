        ...
        <div className={styles.sliderContainer}>
            <div id='slider' className={styles.sliderWrapper}>
                ...
                >
                    ...
                    <ul className={styles.sizesOptions}>
                        <li className={styles.sizesOptionContainer}>
                            <input className='defaultCheckBox' type="checkbox" name="sizeoption" id='optionSize1' />
                            <label className={styles.sliderCardOption} htmlFor="optionSize1">менее 36</label>
                        </li>
                        <li className={styles.sizesOptionContainer}>
                            <input className='defaultCheckBox' type="checkbox" name="sizeoption" id='optionSize2' />
                            <label className={styles.sliderCardOption} htmlFor="optionSize2">36-38</label>
                        </li>
                        <li className={styles.sizesOptionContainer}>
                            <input className='defaultCheckBox' type="checkbox" name="sizeoption" id='optionSize3' />
                            <label className={styles.sliderCardOption} htmlFor="optionSize3">39-41</label>
                        </li>
                        <li className={styles.sizesOptionContainer}>
                            <input className='defaultCheckBox' type="checkbox" name="sizeoption" id='optionSize4' />
                            <label className={styles.sliderCardOption} htmlFor="optionSize4">42-44</label>
                        </li>
                        <li className={styles.sizesOptionContainer}>
                            <input className='defaultCheckBox' type="checkbox" name="sizeoption" id='optionSize5' />
                ...
                <SliderCard
                    ...
                    switchSlide={switchSlide}
                >
                    <form className={styles.userInfoCard}>
                        ...
                        <input className={styles.userInfoInput}
                            type="text"
                            name='name'
                            id='inputUserName'
                        ...
                        <input className={styles.userInfoInput}
                            ...
                            placeholder='E-mail'
                        />
                        <button type='submit' className={styles.submitUserInfoButton}>
                            Получить
                        </button>
                    </form>
                </SliderCard>
